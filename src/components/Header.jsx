  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
        <nav className="flex justify-center items-center py-2 px-2">
          {user ? (
            <>
              {/* Menu de navegação principal */}
              <div className="flex justify-center items-center w-full">
                {isEmpresa ? (
                  // Menu para empresas - 6 ícones bem distribuídos
                  <div className="flex justify-between items-center w-full max-w-md">
                    <Link to="/empresa-home" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                    ...
                    <Link to="/vagas-publicadas" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
                      <span className="text-xs">Vagas</span>
                    </Link>
                    <Link to="/candidaturas" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                      </svg>
                      <span className="text-xs">Candidatos</span>
                    </Link>
                    <Link to="/mensagens" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                      </svg>
                      <span className="text-xs">Mensagens</span>
                    </Link>
                    <Link to="/perfil-empresa" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                      <span className="text-xs">Perfil</span>
                    </Link>
                    <Link to="/monetizacao" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  // Menu para candidatos - 6 ícones bem distribuídos
                  <div className="flex justify-between items-center w-full max-w-md">
                    <Link to="/" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                      </svg>
                      <span className="text-xs">Início</span>
                    </Link>
                    <Link to="/vagas" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2V6" />
                      </svg>
                      <span className="text-xs">Vagas</span>
                    </Link>
                    <Link to="/chamados" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link to="/perfil" className="flex flex-col items-center py-2 px-1 text-gray-600 hover:text-blue-600 transition">
                      <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                      <span className="text-xs">Perfil</span>
            ...
            // Menu para usuários não logados - 5 ícones bem distribuídos
            <div className="flex justify-between items-center w-full max-w-sm">
              <Link to="/" className="flex flex-col items-center py-2 px-2 text-gray-600 hover:text-blue-600 transition">
                <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
                <span className="text-xs">Início</span>
              </Link>
              <Link to="/vagas" className="flex flex-col items-center py-2 px-2 text-gray-600 hover:text-blue-600 transition">
                <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2V6" />
                </svg>
                <span className="text-xs">Vagas</span>
              </Link>
              <Link to="/chamados" className="flex flex-col items-center py-2 px-2 text-gray-600 hover:text-blue-600 transition">
                <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-xs">Chamados</span>
              </Link>
              <Link to="/login" className="flex flex-col items-center py-2 px-2 text-gray-600 hover:text-blue-600 transition">
                <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                </svg>
                <span className="text-xs">Entrar</span>
              </Link>
              <Link to="/cadastro" className="flex flex-col items-center py-2 px-2 text-gray-600 hover:text-blue-600 transition">
                <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
